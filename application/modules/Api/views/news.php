                                 ...
                                 <li>
                                    ...
                                    <div class="timeline-item">
                                        ...
                                        <div class="timeline-body" style="text-align: justify; font-size: 16px;">
                                            ...
                                            <div class="row">
                                             <form role="form" method="post" action="<?php echo base_url('Api/getPostDeal')?>" enctype="multipart/form-data">
  
                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                    <fieldset enabled="">
                                                     <div class="form-group">
                                                      <!-- <label><h3><b><?php echo $this->lang->line('msg_leave_your_deal'); ?></b></h3></label> -->

	...
	<div class="row">
		<div class="col-md-12">
				...
				<div class="twPc-div" >
                    ...
                    <button type="button" name="ctBtn" value="<?php echo $id;?>" class="btn btn-sm  btn-info btn-outline pull-right1 comment" data-trigger1="focus" ><?php echo $this->lang->line('msg_prf_comment'); ?></button>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				            <!-- Chat Button -->   
						</div>
            ...
            <div style="padding: 2px 10% 2px 10%;"> <?php echo $msg;?> </div>
						...
						<div style="padding: 10px 20px 10px 20px; text-align: justify;">
							<b><?php echo $this->lang->line('msg_prf_desc'); ?> : </b>
							<p>
								<?php echo $description;?>
							</p>
						</div>
						<div style="padding: 10px 20px 10px 20px;">
							<b><?php echo $this->lang->line('msg_prf_location'); ?> : </b>
							<ul>
								<li><?php echo $phyaddress;?></li>
							</ul>
						</div>
						<div style="padding: 10px 20px 10px 20px;">
							<b><?php echo $this->lang->line('msg_prf_contacts'); ?> : </b>
							<ul>

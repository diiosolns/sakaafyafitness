...
<!-- -------------------- large device--------------------- -->
  ...
  <div class="jobpan hidden-xs hidden-sm" style="background-color: #fff;">
    <?php echo $msg; ?>
    <form action="<?php echo base_url('Job/modifyjob/')?><?php echo $jobRes->id; ?>" method="post" enctype="multipart/form-data">
     <div class="grp">
        <h4><b>Choose a name for your project</b></h4>
        <div class="form-group">
              <!-- <label for="body">Artical Heading</label> -->
            <input type="text" name="jobtitle" value="<?php echo $jobRes->jobtitle; ?>" class="form-control in" id="heading" placeholder="Eg. Build me a website" required="">
        </div>
     </div>
     ...
     <div class="grp">
        ...
        <div class="form-group">
            ...
            <textarea class="textarea1" name="description" rows="10" class="form-control in_a" required="" placeholder="Describe your job here" style="width: 100%; font-size: 18px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $jobRes->description; ?></textarea>
        </div>
     </div>
     ...
     <div class="grp">
        ...
        <div class="form-group">
          ...
          <select id="subject" name="serviceid" class="form-control in_s" required="required">
              <option value="<?php echo $jobRes->serviceid; ?>" selected="selected" ><?php echo $jobRes->cat; ?> </option>
              <?php foreach ($services->result() as $row): ?>
              <option value="<?php echo $row->id;?>"><?php echo $row->service;?></option>
              <?php endforeach; ?>
          </select>
     ...
     <div class="grp">
        ...
        <div class="form-group">
          ...
          <select id="subject" name="budget" class="form-control in_s" required="required">
              <option value="<?php echo $jobRes->budget; ?>"><?php echo $jobRes->budget; ?></option>
    ...
    <div class="grp">
        ...
        <div class="form-group">
              <!-- <label for="body">Artical Heading</label> -->
            <input type="text" name="skills" value="<?php echo $jobRes->skills; ?>" class="form-control in" id="heading" placeholder="Eg. php, Java script, html, graphics, photoshop etc. " required1="">
        </div>
     </div>
     ...
     <div class="grp">
        <hr>
        <div class="form-group ">
          <button type="submit" name="jobBtn" value="<?php echo $jobRes->jobid; ?>" class="btn btn-info btn-lg pull-right" style="font-size: 18px;">&nbsp;&nbsp;&nbsp;&nbsp;<b>Update job/ project</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
        </div>
     </div>
    ...
    <div class="grp">
     ...
     <div class="grp" >
        ...
        <div class="form-group" style="text-align: center;">
          <button type="submit" name="jobBtn" value="<?php echo $jobRes->jobid; ?>" class="btn btn-info btn-lg pull-right1" style="font-size: 18px;">&nbsp;&nbsp;&nbsp;&nbsp;<b>Update job/ project</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
        </div>
     </div>

                                            <div class="box box-info  " style="margin-top: 15px;">
                                                <div class="box-header">
                                                    <h3 class="box-title"><b><?php echo $this->lang->line('msg_manage_profile_timetable'); ?></b></h3>
                                                </div><!-- /.box-header -->
                                                         ...
                                                         <?php foreach ($profileRes->result() as $row): ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <button type="submit" class="btn btn-default btn-md " name="viewBtn" value="<?php echo $row->id;?>" data-toggle="tooltip"  title="" data-original-title="View Timetable" style="border-radius: 50px;" ><i class="fa fa-calendar"></i></button> &nbsp; &nbsp; &nbsp;
                                                                        <button type="submit" class="btn btn-info btn-md"  name="editBtn" value="<?php echo $row->id;?>" data-toggle="tooltip" title="" data-original-title="Edit Timetable" style="border-radius: 50px;" ><i class="fa fa-edit"></i></button> 

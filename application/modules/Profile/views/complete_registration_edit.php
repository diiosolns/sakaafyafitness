                           ...
                           <div class="box-body" style="text-align: left;">
                            ...
                            <div class="row">
                                <div class="col-md-12 sitecolor1" style="font-size: 28px; text-align: center; padding-top: 10px; padding-bottom: 10px; background-color: #F4F4F4;">
                                    ...
                                    <b class="sitecolor1">Update Profile Information <?php //echo $this->lang->line('msg_create_new_profile'); ?></b>
                                     <!-- <hr>  -->    
                                </div>  
                                <div class="col-md-12"  style="text-align: center; font-size: 14px; padding-bottom: 20px;">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12" style1="margin-bottom: 30px; margin-top: 20px;">
                                                <div class="form-group" >
                                                    ...
                                                    <input type="text" class="form-control  field-long input-sm1" name="pname" value="<?php echo $editRes->row()->profilename; ?>" placeholder="<?php echo $this->lang->line('msg_enter_profile_name'); ?>"  required="">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class=" field-select input-sm1" name="gender"  id="gender" required="">
                                                        <option value="<?php echo $editRes->row()->gender; ?>"><?php echo $editRes->row()->gender; ?><?php //echo $this->lang->line('msg_select_profile_type'); ?></option>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class=" field-select input-sm1" name="age" id="age" required="">
                                                        <option value="<?php echo $age; ?>"><?php echo $age; ?><?php //echo $this->lang->line('msg_select_profile_type'); ?></option>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control  field-long input-sm1" name="idno" id="idno" value="<?php echo $editRes->row()->idno; ?>" placeholder="National ID/Driving license<?php //echo $this->lang->line('msg_enter_profile_name'); ?>"  required="">
                                                    </div>
                                                  </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="custom-file-upload"><img class="thumbnail" id="img1" src="<?php echo base_url('assets/img/profile/0/'.$editRes->row()->img);?>" alt="Profile pic" width="100%" /><input accept="image/*" type='file' id="img" name="img" /><i class="fa fa-upload"></i> Choose Photo</label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class=" field-select input-sm1" name="type" id="type" required="">
                                            <option value="<?php echo $editRes->row()->type; ?>"><?php echo $editRes->row()->type; ?></option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="field-select" name="cat" id="category" required="">
                                            <option value="<?php echo $editRes->row()->category; ?>"><?php echo $editRes->row()->category; ?><?php //echo $this->lang->line('msg_select_profile_category'); ?></option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="subcat" id="subcategory" required="">
                                            <option value="<?php echo $editRes->row()->subcategory; ?>"><?php echo $editRes->row()->subcategory; ?><?php //echo $this->lang->line('msg_select_profile_subcategory'); ?></option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input type="text"  class="field-long" name="phone" value="<?php echo $editRes->row()->phone; ?>" placeholder="Eg. 07XXXXXXXX<?php //echo $this->lang->line('msg_enter_phone_number'); ?>"   required="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input type="text"  class="field-long" name="altphone" value="<?php echo $editRes->row()->altphone; ?>" placeholder="Eg. 07XXXXXXXX<?php //echo $this->lang->line('msg_enter_alt_phone_number'); ?>"   >
                                        </div>
                                      </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="form-group field-select">
                                            ...
                                            <input type="email"  class="field-long" name="email" value="<?php echo $editRes->row()->email; ?>" placeholder="Enter e-mail<?php //echo $this->lang->line('msg_enter_email_address'); ?>"   required="">
                                        </div>
                                      </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input type="text"  class="field-long" name="phyaddress" value="<?php echo $editRes->row()->phyaddress; ?>" placeholder="<?php //echo $this->lang->line('msg_enter_physical_address'); ?>"   required="">
                                        </div>
                                      </div>
                                </div>  
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <textarea name="desc" rows="4" class="textarea field-long field-textarea" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" required=""> <?php echo $editRes->row()->description; ?> </textarea>
                                        </div>
                                      </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <button type="submit" name="modifyBtn" value="<?php echo $editRes->row()->id; ?>" class="btn btn-info btn-lg pull-right">&nbsp;&nbsp;&nbsp;&nbsp;UPDATE<?php //echo $this->lang->line('msg_submit'); ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
                                </div>
                            </div>  
                            <!-- <hr> -->
                        </div><!-- /.box-body -->

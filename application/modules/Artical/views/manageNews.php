<div class="box box-info" style="margin-top: 15px;">
                                                <div class="box-header">
                                                    <h3 class="box-title"><b><?php echo $this->lang->line('msg_manage_posts_deals'); ?></b></h3>
                                                </div><!-- /.box-header -->
                                                <div class="box-body padding">
                                                <form action="<?php echo base_url('Artical/manageNews')?>" method="post">
                                                    <table class="table table-striped">
                                                        <tbody><tr><!-- <?php echo $this->lang->line('msg_'); ?> -->
                                                            <th style="width: 10px">#</th>
                                                            <th><?php echo $this->lang->line('msg_news_heading'); ?></th>

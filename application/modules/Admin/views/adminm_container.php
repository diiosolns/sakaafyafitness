...
<div class="row">
        ...
        <div class="brand-wrapper">
            ...
            <div class="brand-name-wrapper">
                <a class="navbar-brand" href="<?php echo base_url('#');?>">
                    ...
                    <br>
                    <!-- <small>Position: <?php echo $this->session->userdata('user_role');?></small>  -->
                    <!-- small>Welcome.!</small> -->
                </a>
            </div>
    ...
    <div class="side-menu-container">
        <ul class="nav navbar-nav">
            ...
            <li><a href="<?php echo base_url('Chat/myChats');?>"><span class="fa fa-comment"></span> <?php echo $this->lang->line('msg_my_chats'); ?></a></li>
            ...
            <li class="panel panel-default" id="dropdown">
                ...
                <div id="dropdown-5" class="panel-collapse collapse">
                    <div class="panel-body">
                        <ul class="nav navbar-nav">
                            <!-- <li><a href="<?php //echo base_url('#');?>">Create New Account</a></li> -->

<div class="box box-info  " style="margin-top: 15px;">
    <div class="box-header">
        <h3 class="box-title"><b><?php echo $msg; ?></b></h3>
        <div class="pull-right" style="padding-top: 10px;">
            <a href="<?php echo base_url('Admin/PaidUsers/expired');?>" class="btn btn-default btn-sm pull-right">Expired Subscriptions&nbsp;&nbsp;<i class="fa fa-arrow-circle-right"></i></a>
            <a href="<?php echo base_url('Admin/PaidUsers/paid');?>" class="btn btn-default btn-sm pull-right">Active Subscriptions&nbsp;&nbsp;<i class="fa fa-arrow-circle-right"></i></a>
        </div>
    </div><!-- /.box-header -->
     <div class="box-body padding" style="overflow-x:scroll; white-space: nowrap;">
    <form action="<?php echo base_url('Admin/PaidUsers')?>" method="post">
        <table class="table table-striped">
            ...
            <?php $index = 1;?>
                ...
                <td>
                    <a href="<?php echo base_url('Profile/userProfile/');?><?php echo $row->id;?>" class="btn btn-default btn-xs "  data-toggle="tooltip"  title="" data-original-title="View Profile"><i class="fa fa-eye"></i></a> 

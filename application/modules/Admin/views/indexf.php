            ...
            <nav class="navbar navbar-static-top" role="navigation">
                ...
                <div class="navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <!-- ======Post job Button=== -->
                        <!-- <li class="">
                            <a href="<?php //echo base_url('Job/post');?>" class1="btn btn-lg btn-info" style="color1: #fff;font-size: 14px; padding-top: 0px, padding-bottom: 0px; " ><b>Post a job (FREE)</b>&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-arrow-circle-right"></i></a>
                        </li> -->
                        <!-- =====end post button ==== -->
                    ...
                    <ul class="sidebar-menu">
                       ...
                       <!--  <li>
                            <a href="<?php echo base_url('Profile/createProfile');?>">
                                <i class="fa fa-folder-open"></i> <span class=""></span> <?php echo $this->lang->line('msg_new_profile'); ?> <small class="badge pull-right bg-red">0</small> 
                            </a>
                        </li>
                        <li class="treeview">
                            <a href="#">
                                <span class="fa fa-user"></span>  
                                <span><?php echo $this->lang->line('msg_my_profile'); ?> </span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url('Profile/managemyProfiles');?>"> <i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('msg_manage_my_profile'); ?></a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
                                <i class="fa fa-tasks"></i>
                                <span class=""> <?php echo $this->lang->line('msg_my_appointments'); ?> </span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url('Appointment/availableAppointments');?>"> <i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('msg_available_appointments'); ?></a></li>
                                <li><a href="<?php echo base_url('Appointment/profileTimetable');?>"> <i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('msg_my_timetable'); ?></a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
                                <i class="glyphicon glyphicon-user"></i>
                                <span class=""> <?php echo $this->lang->line('msg_my_account'); ?> </span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url('Users/changePassword');?>">  <i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('msg_account_details'); ?></a></li>
                                <li><a href="<?php echo base_url('Users/changePassword');?>">  <i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('msg_change_password'); ?></a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">

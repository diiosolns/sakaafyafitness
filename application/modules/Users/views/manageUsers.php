<div class="box box-info  " style="margin-top: 15px;">
    <div class="box-header">
        ...
        <div class="pull-right" style="padding-top: 10px;">
            ...
            <a href="<?php echo base_url('Users/manageUsers/Individual');?>" class="btn btn-default btn-sm pull-right">Individual&nbsp;&nbsp;<i class="fa fa-arrow-circle-right"></i></a>
            <a href="<?php echo base_url('Users/manageUsers/Group');?>" class="btn btn-default btn-sm pull-right">Group/ Team&nbsp;&nbsp;<i class="fa fa-arrow-circle-right"></i></a>
            <a href="<?php echo base_url('Users/manageUsers/Company');?>" class="btn btn-default btn-sm pull-right">Company&nbsp;&nbsp;<i class="fa fa-arrow-circle-right"></i></a>
    ...
    <form action="<?php echo base_url('Users/manageUsers')?>" method="post">
        <table class="table table-striped">
            ...
            <?php $index = 1;?>
                ...
                <td>
                    <a href="<?php echo base_url('Users/verifyUserAccount/');?><?php echo $row->id;?>" class="btn btn-info btn-xs "  data-toggle="tooltip"  title="" data-original-title="Verify user e-mail address"><i class="fa fa-check"></i></a> 

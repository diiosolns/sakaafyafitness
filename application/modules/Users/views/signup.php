                ...
                <div class="body box" >
                    <div class="sitecolor1" style="text-align: center; font-size: 24px; padding-bottom: 10px; padding-top: 10px;">
                     ...
                     <form action="<?php echo base_url('Users/userReg')?>" method="post">
                              ...
                              <div class="form-group">
                                  <input  type="tel" pattern="[0-9]{10}" class="form-control" id="phone" name="phone" value="<?php echo set_value('phone'); ?>"  title="Enter your phone number (Eg. 07XXXXXXXX)" placeholder="<?php echo $this->lang->line('msg_mdl_phone'); ?> (Eg. 07XXXXXXXX)" style="width: 98%;"> 

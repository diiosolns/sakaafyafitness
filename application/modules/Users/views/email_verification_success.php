          ...
          <div class="row verify_box">
            ...
            <div class="col-md-8 ">
              <span><a href="<?php echo base_url();?>"><img src="<?php echo base_url('assets/img/def.png');?>" class="avater" alt="service" style="width: 8%;" ></a>
                 <b class="sitecolor1 verify_header">Verified!</b>
               </span>
               <hr>
              <p class="verify_msg">
                E-mail verification completed successifully! Click the button below to continue to Saka Afya Fitness Club
              </p>
              <div style="text-align: center; padding-top: 20px;">
                <a href="<?php echo base_url('Users/verified_user'); ?>" class="btn btn-lg btn-info">Continue to Saka Afya Fitness Club</a>
              </div>
